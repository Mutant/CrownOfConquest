...
__PACKAGE__->load_classes(qw/
    Items Item_Category Race Item_Type Player Party Terrain Land Dimension Class Character Shop
    ...
    Bomb Kingdom_Claim Kingdom_Claim_Response Global_News Crown_History
/);
