...
__PACKAGE__->has_many(
    'equip_place_categories',
    'RPG::Schema::Equip_Place_Category',
...
sub opposite_hand {
	...
	my ($opposite_hand) = $self->result_source->schema->resultset('Equip_Places')->find(
		{
			equip_place_name => $OPPOSITE_HANDS{$self->equip_place_name},
		},
	);
