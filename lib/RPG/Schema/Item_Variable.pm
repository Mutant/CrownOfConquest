...
__PACKAGE__->add_columns(qw/item_variable_name_id item_variable_id item_variable_value item_id max_value item_enchantment_id name/);
__PACKAGE__->set_primary_key('item_variable_id');

__PACKAGE__->numeric_columns(qw/item_variable_value/);
